      ...
      {!account ? (
        ...
        <main className="main-content">
          <section className="account-info">
            <p>Connected as <span className="highlight">{account}</span></p>
          </section>
          ...
          <section className="mint-section">
            ...
            <div className="input-group">
              ...
              />
              <button className="btn-primary" onClick={mintNFT} disabled={loading}>
          ...
          <section className="sell-section">
            ...
            <div className="input-group">
              ...
              />
              <button className="btn-primary" onClick={listNFTForSale} disabled={loading}>
